...
class TestTakeAssignment(BaseClass):
    ...
    def test_stu_take_ass(self, getData):
        ...
        try:
            assignmentPage.zero_remaining_attempts(TestTakeAssignment.assignment_name)
        except:
            takingAssPage = assignmentPage.go_to_spec_ass(TestTakeAssignment.assignment_name)
    ...
    def test_stu_take_ass_timer(self,getData):
        ...
        try:
            ...
            log.warning('There is no attempt left for' + TestTakeAssignment.assignment_name)
            self.logout()
